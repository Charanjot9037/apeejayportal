...
const validateStudents = (students) => {
  ...
  // Count emails for duplicate checking
...
const downloadTemplate = () => {
  const csvContent = 'name,email\n' + 'Simran Bhandari,Simfran@example.com\n';
...
export default function BulkImport() {
  ...
  return (
    ...
    >
      {({ setFieldValue }) => (
        <Form>
          <div className="mx-auto mt-8 w-full max-w-3xl rounded-xl border border-slate-200 bg-white p-6">
            {/* -------------------------------- */}
            {/* STEP INDICATOR */}
            {/* -------------------------------- */}
            ...
            {step === 1 && (
              <div>
                ...
                <div
                  ...
                  className={`mt-5 flex min-h-[220px] flex-col items-center justify-center rounded-xl border-2 border-dashed p-8 text-center transition ${
                    isDragging
                ...
                >
                  ...
                  <label
                    ...
                    className="mt-3 cursor-pointer rounded-lg bg-primary-orange px-4 py-2 text-sm font-medium text-white hover:opacity-90"
                  >
                    Choose File
                  </label>
